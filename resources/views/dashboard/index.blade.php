    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Lab ICT</div>
            </a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/dashboard/Asisten">
                    <span>present calas</span>
                </a>
                <a class="nav-link collapsed" href="/dashboard/Asisten">
                    
                    <span>present asisten</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="/registuser" class="btn btn-primary btn-icon-split my-2">
                                <span class="icon text-white-50">
                                    <i class="fas fa-plus"></i>
                                </span>
