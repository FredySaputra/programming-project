...
<head>
    ...
    <link rel="stylesheet" href="/css/style.css" href="/dashboard/Asisten">
...
@csrf
    <header>
        ...
        <a href="a" class="cta"><button>Admin</button></a>
    </header>
    <main>
        ...
        <div class="name_list">
            <div class="table">
                <section class="table_header">
                    <h1>Asisten</h1>
                    <form action="/logasisten">
                            @csrf
                        <td><a href="/logasisten""><button  class="presensi" >Presensi</button></a></td>
                        </form>  
                </section>
                ...
                <table>
                        ...
                        @foreach ($presentasisten as $item)
                        <tr onclick="window.location='/formlogout';" style="cursor: pointer;">
                            <td>{{$item->tgl}}</td>
                            <td>{{$item->nim}}</td>
                            <td>{{$item->nama}}</td>
                            <td>{{$item->jabatan}}</td>
